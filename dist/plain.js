...
var Popup = (function (_super) {
    ...
    Popup.prototype.getStyle = function (opt) {
        if (opt === void 0) { opt = {}; }
        var style = 'position: absolute;left: 0;';
...
var B_Map = (function () {
    ...
    B_Map.prototype.load = function (key, resolve, reject) {
        ...
        var url = "https://webapi.amap.com/maps?v=1.4.15&key=" + key + "&callback=" + callbackName;
...
var G_Map = (function () {
    ...
    G_Map.prototype.load = function (key, resolve, reject) {
        ...
        var body = document.body;
        var script = document.createElement('SCRIPT');
        var url = 'http://ditu.google.cn/maps/api/js?key=' + key + '&callback=' + callbackName;
        script.setAttribute('src', url);
        script.setAttribute('defer', '');
        script.setAttribute('async', '');
        body.appendChild(script);
